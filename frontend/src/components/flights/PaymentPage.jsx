...
const PaymentsPage = () => {
  ...
  return (
    <main className='PaymentsPage page px-24 pt-14'>
      <div className='text-primary font-nunito font-extrabold text-2xl mr-auto' >  PaymentMetod</div>
    <p className="text-grey-primary font-nunito text-lg py-4"> Manga Flights processes your payment securely with end-to-end encryption </p>
    ...
    <div className="text-grey-primary font-nunito text-lg pt-14 pb-2 "> Credit Card Details</div>
    <div className='py-2 px-3 w-1/2' >
     ...
     <Input
      ...
      <div className="text-grey-primary font-nunito text-lg pt-6 pb-2 "> Cancellation Policy</div>
     <p className="text-grey-primary font-nunito text-base py-4"> This flight has a flexible cancellation policy.</p>
